...
def main(num: int, output_filename: str, visualize: bool = True) -> None:
    ...
    transform_matrix = np.loadtxt(f"in_hand_control/Cameras/TransformationMatrices/camera2base_matrix_for_image_new{num}.txt")
